            ...
            >
              ...
              <div className="space-y-6 relative z-10 pb-4">
                ...
                <div className="space-y-2">
                  ...
                  <h3 className="text-lg sm:text-xl font-black text-black tracking-tight leading-snug group-hover:text-[#FF4D00] transition-colors drop-shadow-[0_0_12px_rgba(255,255,255,0.95)]" style={{ textShadow: "0 -1px 2px white" }}>
                    {adv.title}
                  </h3>
                </div>
