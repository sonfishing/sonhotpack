...
export default function ProductSpecs() {
  const specs = [
    {
      title: "최고온 발열 - 70도 이상",
      desc: "180g 대용량 기준 70도 이상의 폭발적인 고온 발열 성능으로 야간 가혹한 영하 날씨 조건 속에서도 차가워진 체온을 완벽 사수합니다.",
      icon: Flame,
    },
    {
      title: "20시간 압도적 지속성",
      desc: "180g 대용량 기준 20시간 동안 꺼지지 않는 지속 온기를 유지하여 동계 고지대 철야 야간 작업 및 한랭 근무 교대 시 최적입니다.",
      icon: Clock,
    },
    {
      title: "100% 국산 안심성분",
      desc: "품질 좋은 국내산 외장 부직포와 안심 원재료, 안전한 친환경 성분만을 사용하여 터짐이 없고 냄새와 피부 자극 부담에서 안심입니다.",
      icon: Sparkles,
    },
    {
      title: "다양한 제품 라인업",
      desc: "대용량, 실속형, 미니 주머니형은 물론 붙이는 어깨 및 파스형 핫팩, 발가락 전용과 깔창형 및 방석형까지 모든 현장 맞춤입니다.",
      icon: Layers,
    },
  ];
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/90 font-sans leading-relaxed text-sm sm:text-base mt-6 font-medium text-shadow-sm">
            최고 등급의 화력 배합 기술과 정교한 마감 검수를 조율해 탄생했습니다.
            혹독한 기온 저하 위협에도 확실하게 온난 상태를 영속 공급해 드립니다.
          </p>
        </div>
